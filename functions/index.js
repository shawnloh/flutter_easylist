...
const gcconfig = {
    projectId: 'flutter-product-fe28f',
    keyFileName: 'flutter-product.json'
};

fbAdmin.initializeApp({
    credential: fbAdmin.credential.cert(require('./flutter-product.json')),
});
...
exports.storeImage = functions.https.onRequest((req, res) => {
    return cors(req, res, () => {
        ...
        busboy.on('finish', () => {
            const bucket = gcs.bucket('flutter-product-fe28f.appspot.com');
            const id = uuid();
